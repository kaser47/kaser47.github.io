...
{
    public class AnimatedMovieStrategy : IStrategy
    {
        public ConcurrentBag<Show> GetShows(DateTime date)
        {
            ...
            var selector = @"//*[@class='recent-release' and contains(.,'Movies')][2]/following-sibling::div[1]/ul/li";
            ...
            Parallel.ForEach(nodesMatchingXPath, node =>
            {
                ...
                shows.Add(new Show(name, urlValue, imageValue, ShowType.AnimatedMovie, date));
            });
